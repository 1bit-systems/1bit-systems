...
| **Phase 5** | Productionization (Windows support, package registries) | ✅ Mostly done |

See [docs/roadmap.md](docs/roadmap.md) for the detailed plan with benchmarks and targets.
