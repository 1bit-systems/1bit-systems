...
> **291 tok/s** NPU fused (raw) · **63 tok/s** NPU FLM (validated production, Jul 8) · **269 tok/s** GPU Ollama Q2_K (Jul 8) · **307 tok/s** GPU 1.58-bit ternary (validated) · **228 tok/s** GPU 1-bit Bonsai Q1_0 (llama.cpp, Jul 8) · **30 KB** fused layer binary · **55.7 TFLOPS** INT8 GEMM peak · **73+ models** across 6 backends · **22 multi-modal** · Zero Python · MIT
>
