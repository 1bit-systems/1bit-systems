...
This confirmed, with hard numbers, what `docs/V12-CORRECTNESS-BLOCKER.md` suspected
...
- Everything downstream of the GEMM kernels (attention, RoPE, KV cache, LM head)
  ...
  `docs/V12-CORRECTNESS-BLOCKER.md`) — worth re-auditing now that the GEMM itself
