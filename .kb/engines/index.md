...
- [NPU Inference Engine (C++ v12)](npu_engine.md) — Production inference engine on AMD NPU via XRT. 97 tok/s Qwen3-0.6B, 10.3 ms/tok decode.  [Engine]
...
- [Unified Serving Daemon](unified_daemon.md) — Single 74 KB binary serving all models via a HTTP API (OpenAI-compatible), proxying through C++ v12 (NPU) or FLM fallback.  [Engine]
