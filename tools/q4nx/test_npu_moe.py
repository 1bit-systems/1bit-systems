...
ENGINE = sys.argv[1] if len(sys.argv) > 1 else "/home/bcloud/engine/npu/build/npu_engine_universal"
MODEL = sys.argv[2] if len(sys.argv) > 2 else "/home/bcloud/.config/flm/models/Qwen3-0.6B-NPU2/model.q4nx"
