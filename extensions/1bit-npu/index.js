...
/** @type {import('@earendil-works/pi-agent-core').Extension} */
const extension = {
  name: "1bit-npu",
  description: "Manage the 1bit NPU inference stack — start, stop, query models, build engines.",

  /**
   * @param {import('@earendil-works/pi-agent-core').ExtensionApi} api
   */
  activate(api) {
    api.registerTool({
      name: "npu_status",
