...
inline bool json_find_string(const std::string& text, const std::string& key, std::string& out) {
...
inline bool json_find_int(const std::string& text, const std::string& key, int& out) {
    auto pos = text.find("\"" + key + "\"");
    if (pos == std::string::npos) return false;
    pos = text.find(':', pos);
    if (pos == std::string::npos) return false;
...
inline bool json_find_float(const std::string& text, const std::string& key, float& out) {
    auto pos = text.find("\"" + key + "\"");
    if (pos == std::string::npos) return false;
    pos = text.find(':', pos);
    if (pos == std::string::npos) return false;
...
inline bool read_safetensors_metadata(const std::string& path, ModelConfig& cfg) {
    Q4nxReader r;
